...
export class ToDoCreator extends Component {
  ...
  //feature 5b
  //  The updateNewToDoItem method is for the onChange event of the input box below for 
  //adding a new todo item.  The updateNewToDoItem takes in the event from the onChange 
  //and sets the state of the newToDoItem property

  updateNewToDoItem = (event) => { this.setState({ newToDoItem: event.target.value }); }
